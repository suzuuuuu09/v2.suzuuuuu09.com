...
[GitHub - lint-staged/lint-staged: 🚫💩 — Run tasks like formatters and linters against staged git files](https://github.com/lint-staged/lint-staged#installation-and-setup)